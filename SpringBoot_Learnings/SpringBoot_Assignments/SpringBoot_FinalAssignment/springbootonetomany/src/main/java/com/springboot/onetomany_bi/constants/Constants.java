...
public class Constants {
    ...
    public static final String COMMENT_CONTENT_NULL_OR_EMPTY = "Content cannot be null or empty and Content must be between 5 and 50 characters";
    ...
    public static final String TITLE_REQUIRED = "Title cannot be null or empty and Title must be between 5 and 20 characters";
